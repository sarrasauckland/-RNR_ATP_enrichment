...
# --- Observed counts from your summary ---
total_genes = 4448          # all genes in REL606
total_atp = 296             # ATP-consuming genes
mutated_genes = 1025        # unique mutated genes
mutated_atp_genes = 78      # unique ATP-consuming genes mutated

# --- Event-level counts ---
total_events = 1557
atp_events = 107  # observed ATP hits
...
# EVENT-LEVEL TEST
# -------------------------------
# Create contingency table for event-level
# comparing ATP vs non-ATP mutations and ATP vs non-ATP background
...
# OUTPUT
# -------------------------------
print("📊 Enrichment Summary (DEL version)")
print("----------------------------------------")
